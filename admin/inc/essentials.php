<?php 
  ...
  define('SITE_URL','http://127.0.0.1/hbwebsite/hbwebsite/');
  ...
  define('SENDGRID_API_KEY',"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");
  define('SENDGRID_EMAIL',"mgidoji626@gmail.com");
  define('SENDGRID_NAME',"Atithi Satkar");
  ...
  function uploadImage($image, $folder)
{
  ...
  if (!in_array($img_mime, $valid_mime)) {
    ...
    return 'inv_size'; // Image size greater than 2MB
  } else {
